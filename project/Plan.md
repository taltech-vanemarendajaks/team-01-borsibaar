...
- [ ] mingisugune light-weight svelte komponentide raamistik üles seada (btn, card, textfield, mida veel vaja?)
...
- [ ] mingi algne andmebaasi word tabelite koosseis (user >-< user_word >-< word_key >-< word_value)
- [ ] BE põhilised word endpointid - toimetada saab vaid enda ressurssidega:
  - [ ] POST words/{id}
  - [ ] PATCH words/{id}
  - [ ] DELETE words/{id} - soft delete, v.a. kui on custom word, sest sama word võib ka teistel kontodel olla
  - [ ] GET words?filter=abs + pagination?
- [ ] FE vaated:
  - [ ] Kirje lisamise/muutmise vaade
  - [ ] Kirjete listivaade + filtrid
  - [ ] Quiz režiim vaade
...
- [ ] Testide jooksutamien PRi avades, edukas run saab olema eeldus mergemiseks
